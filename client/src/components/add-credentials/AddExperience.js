                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <p className="lead text-center">Add any job or postion that you have had in the past or current</p>
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <TextFieldGroup type="text" placeholder="* Job Title" name="title"
                                ...
                                <TextAreaFieldGroup placeholder="Job Description" onChange={this.onChange}
